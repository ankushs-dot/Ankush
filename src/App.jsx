...
export default function App() {
  ...
  const bookingUrl =
    "https://calendar.google.com/calendar/u/0/appointments/schedules/AcZssZ3k31eKNRs1ull4ITM9bp3lYEr5nJLL-Rbe14uJF81txizuwjqC19rzINTRtFEWK6wXkfZaaFQ_";
          ...
          <div className="container hero-grid">
            <div className="hero-copy">
              ...
              <div className="hero-fineprint">
                <span className="dot"></span> No credit card • 5‑minute setup • Cancel anytime
              </div>
            </div>
              ...
              <div className="orb-wrap">
                ...
                <div className="mini-stats">
                  <div className="mini-stat">
                    <div className="mini-top">14.7M+</div>
                    <div className="mini-sub">Calls handled</div>
                  </div>
                  <div className="mini-stat">
                    <div className="mini-top">860K+</div>
                    <div className="mini-sub">Booked</div>
                  </div>
                  <div className="mini-stat">
                    <div className="mini-top">18.7M+</div>
                    <div className="mini-sub">Messages</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="cta" aria-label="Call to action">
          <div className="container cta-card">
            <div className="cta-copy">
              <div className="cta-kicker">Ready to stop losing revenue?</div>
              <div className="cta-title">
                Join the 500+ businesses using CWA to automate their growth.
              </div>
            </div>
            <div className="cta-actions">
              <a className="btn btn-primary cta-btn" href="#getting-started">
